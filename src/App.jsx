...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(6,13,36,0.42),transparent_32%),radial-gradient(circle_at_78%_18%,rgba(13,45,98,0.24),transparent_28%),radial-gradient(circle_at_18%_82%,rgba(85,48,180,0.22),transparent_31%),radial-gradient(circle_at_52%_56%,rgba(12,104,125,0.18),transparent_34%),linear-gradient(135deg,#050A1C_0%,#060D24_24%,#09224E_48%,#0C687D_70%,#5530B4_100%)]" />
